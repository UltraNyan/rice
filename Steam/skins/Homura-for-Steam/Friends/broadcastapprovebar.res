"friends/broadcastapprovebar.res"
{
	styles {
		...
		URLLabel { font-weight=700 font-style=uppercase textcolor=White }
	}
	...
	layout {
		...
		place { control=ApproveLabel,OrLabel,IgnoreLabel y=29 margin-right=27 spacing=3 align=top-center }
