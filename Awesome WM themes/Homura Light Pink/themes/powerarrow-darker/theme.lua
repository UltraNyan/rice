...
theme.font                          = "Sansation Light 15"
theme.fg_normal                     = "#696a65"
theme.fg_focus                      = "#ac7575"
theme.fg_urgent                     = "#ac7575"
theme.bg_normal                     = "#e5e6e1"
theme.bg_focus                      = "#e1cae9"--color2
theme.bg_urgent                     = "#e5e6e1"
theme.border_width                  = "1"
theme.border_normal                 = "#cecece"
theme.border_focus                  = "#e3ecf0"
theme.border_marked                 = "#ac7575"
theme.titlebar_bg_focus             = "#74adc2"
theme.titlebar_bg_normal            = "#74adc2"
theme.taglist_fg_focus              = "#5d8b90"
theme.tasklist_bg_focus             = "#e5e6e1"
theme.tasklist_fg_focus             = "#6b94a1"
