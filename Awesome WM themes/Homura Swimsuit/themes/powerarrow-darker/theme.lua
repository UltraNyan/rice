...
theme.font                          = "Sansation Light 9" --AutoRice Main Font
theme.fg_normal                     = "#758977" --AutoRice Font Color
theme.fg_focus                      = "#ac7575"
theme.fg_urgent                     = "#ac7575"
theme.bg_normal                     = "#423f51" --AutoRice Main color 1
theme.bg_focus                      = "#574a5f"--AutoRice Main color 2
theme.bg_urgent                     = "#f1ecf3"
theme.border_width                  = "1" --AutoRice Window border width
theme.border_normal                 = "#2e372f" --AutoRice border normal
theme.border_focus                  = "#335168" --AutoRice border focus
theme.border_marked                 = "#ac7575"
theme.titlebar_bg_focus             = "#74adc2"
theme.titlebar_bg_normal            = "#74adc2"
theme.taglist_fg_focus              = "#5d8b90"
theme.tasklist_bg_focus             = "#645C74" --AutoRice Tasklist bg focus
theme.tasklist_fg_focus             = "#c9caa9" --AutoRice Tasklist focus font color
...
theme.mouse_finder_color            = "#ac7575"
